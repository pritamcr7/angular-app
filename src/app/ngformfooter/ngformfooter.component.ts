...
export class NgformfooterComponent implements OnInit {
  ...
  addStudent(student_name,student_id,student_skills,student_project,student_hcm){
    let student={
      Name:"",
      ID:0,
      Skills:"",
    ...
    student.Name=student_name.value;
    student.ID=student_id.value;
    student.Skills=student_skills.value;
    student.Project=student_project.value;
    student.HCM=student_hcm.value;



    this.shared.changeMessage1(student.Name);
    this.shared.changeMessage2(student.ID);
